...
class CreateNewAnnouncement : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.create_new_announcement, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateNewAnnouncement.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateNewAnnouncement().apply {
